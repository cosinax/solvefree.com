...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://solvefree.com/space" },
};

const calculators = [
  {
    title: "Relativistic Rocket Travel",
    description: "Ship time vs. Earth time for constant-accel/decel interstellar travel",
    href: "/space/relativistic-travel",
    icon: "rocket",
  },
  {
    title: "Velocity Time Dilation",
    description: "Lorentz factor γ and special-relativistic time dilation",
    href: "/space/time-dilation",
    icon: "timer",
  },
  {
    title: "Relativistic Velocity & Momentum",
    description: "Velocity addition, momentum, kinetic energy, Doppler shift",
    href: "/space/relativistic-velocity",
    icon: "zap",
  },
  {
